...
def custom_append(input_list, value):
    ...
    #Appending with a [list], creates a two-dimensional list AKA a list within a list

def custom_extend(input_list, values):
    """custom_extend(input_list, values) imitates input_list.extend(values)"""
    input_list[len(input_list):] = values
    #Extending a [list] adds extra items (non-lists) to the existing [list]

def custom_insert(input_list, index, value):
    """custom_insert(input_list, index, value) imitates
    input_list.insert(index, value)
    """
    #some_list[start:end] = another_list
...
def custom_reverse(input_list):
    ...
    for i in range(len(input_list)/2):
        ...
        #input_list[0] = input_list[(12-0) -1]
        input_list[len(input_list)] = t
